...
namespace EE::Render
{
    ...
    public:
        ...
        inline RHI::RHIBuffer const* GetVertexBuffer() const { return m_vertexBuffer.GetRHIBuffer(); }
        ...
        inline RHI::RHIBuffer const* GetIndexBuffer() const { return m_indexBuffer.GetRHIBuffer(); }
