...
1. Download the [external dependencies](https://drive.google.com/file/d/1cHx6Kcm8GlK91Qm48Sg-r-fMtcGgNLGL/view?usp=sharing) and extract into the Esoterica root folder (X:/Esoterica Path/). You should end up with 'X:/Esoterica Path/External/'.
